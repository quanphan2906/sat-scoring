<signup>
    ...
    <div id="register-wrapper">
        <div id="assistant-register-container" class="flex-row">
            <img class="register-img" src="../assets/assistant.png" alt="">
            <div class="flex-col">
                <div class="font-20px margin-bot-12px" style="margin-left: 96px;">Julius's assistant? Sign up here!</div>
                <form action="" class="flex-col margin-top-24px" style="margin-left: 96px;">
